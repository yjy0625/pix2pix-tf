...
flags.DEFINE_float("lr_g", 1e-6, "Learning rate for generator [1e-4]")
flags.DEFINE_float("lam", 100, "Lambda value for g_l1_loss [100]")
flags.DEFINE_integer("batch_size", 8, "Number of images in batch [64]")
# dataset params
...
# flags for running
flags.DEFINE_string("version", "v0.1_l1-loss-only_lr1e-6", "Name of experiment for current run [experiment]")
