...
flags.DEFINE_float("lr_d", 2e-4, "Learning rate for discriminator [1e-8]")
flags.DEFINE_float("lr_g", 2e-4, "Learning rate for generator [1e-4]")
flags.DEFINE_float("lam", 10.0, "Lambda value for g_l1_loss [100]")
flags.DEFINE_integer("batch_size", 1, "Number of images in batch [64]")
# dataset params
...
# flags for running
# flags.DEFINE_string("version", "v0.3.2_lr2e-4_bs01_lam100", "Name of experiment for current run [experiment]")
flags.DEFINE_string("version", "debug", "Name of experiment for current run [experiment]")
...
flags.DEFINE_boolean("restore", True, "Restore the model or not [True]")
# directory params
